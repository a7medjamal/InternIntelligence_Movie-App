...
class NewRealeases {
  ...
  NewRealeases.fromJson(dynamic json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        _results?.add(ResultsReal.fromJson(v));
      });
    }
  ...
  num? get page => _page;
  List<ResultsReal>? get results => _results;
...
class ResultsReal {
  ...
  ResultsReal.fromJson(dynamic json) {
    _adult = json['adult'];
